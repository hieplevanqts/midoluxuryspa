...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnadmin/store/Ds_shopping')?>">Danh sách vị trí Shopping</a></li>
            ...
            <div class="col-md-9" style="font-size: 12px">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group clearfix" style="padding: 0px 15px;">
							<div style="width:100%;position: relative; background-color: rgb(229, 227, 223); overflow: hidden;" class="main_mapsmall" id="map_canvas_detail">
