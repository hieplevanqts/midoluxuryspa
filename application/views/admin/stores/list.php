...
<section class="content-header">
    <h1>
        Trang  danh sách cửa hàng hệ thống
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?= base_url('vnadmin')?>"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
        <li class="active"><a href="<?= base_url('vnadmin/store/Ds_shopping')?>">Trang danh sách shop</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('vnadmin/store/add')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form name="formbk" method="post" action="<?=base_url('vnadmin/store/deletes')?>">
                <table id="myTable2" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th width="10%" class="no-sort">Tên shop</th>
                            <th width="12%">Địa chỉ shop</th>
                            <th width="8%" class="no-sort">Điện thoại</th>
                            <th width="10%" class="no-sort">Tìm kiếm shop</th>
                            <th width="2%" class="no-sort text-center">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                       <?php if (isset($list)) {
                        ...
                        <tr>	
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('vnadmin/store/edit/'.$v->id)?>" class="btn btn-xs btn-default">
                                <i class="fa fa-pencil"></i>
                                </a>
                                <a href="<?= base_url('vnadmin/store/delete/'.$v->id)?>" class="btn btn-xs btn-danger">
