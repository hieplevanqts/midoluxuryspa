                  ...
                  <div class="tab-content">
                     ...
                     <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <label  class="col-sm-12">Chi tiết sản phẩm</label>

                           <div class="col-sm-12">

                              <textarea name="detail" class="form-control input-sm" placeholder=""

                                 id="ckeditor_detail1" rows="4"><?=@$edit->detail;?></textarea>
                     ...
                     <div id="menu1" class="tab-pane fade">
                        ...
                        <div class="form-group">
                           ...
                           <label class="col-sm-2 form-text">Xuất sứ :</label>

                           <div class="col-sm-5">

                              <input type="text" name="caption_1" 
                        ...
                        <div class="form-group">
                           ...
                           <label class="col-sm-2 form-text">Size:</label>

                           <div class="col-sm-5">

                              <input type="text" name="caption_2" 
                        ...
                        <div class="form-group">
                           ...
                           <label class="col-sm-2 form-text">Thành phần :</label>

                           <div class="col-sm-5">

                              <input type="text" name="caption_3" 

                                

                                 class="auto form-control input-sm"

                                 value="<?= @$edit->caption_3; ?>" placeholder=""/>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      CKEDITOR.replace( 'ckeditor_detail1', {
