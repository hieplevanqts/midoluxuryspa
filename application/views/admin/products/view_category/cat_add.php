					...
					<div class="panel-body">
						<div class="tab-content">
							<div id="home" class="tab-pane fade in active">
								...
								</div> 								<div class="form-group">									<label class="col-sm-12 form-text">										Danh mục cha</label>									<div class="col-sm-12" style="border: 0px solid #ccc;padding: 5px">										<div class=" checklist_cate cat_checklist">											<select class="form-control" name="parent">												<option value="0">Danh mục cha</option>											<?php if (isset($edit->parent_id)) $cate_selected = $edit->parent_id;											else $cate_selected = null;											show_cate($cate, 0, '', @$cate_selected)?>											</select>										</div>									</div>								</div>								<div class="form-group hidden">									<label  class="col-sm-12">Mô tả</label>									<div class="col-sm-12">										<textarea name="description" class="form-control input-sm" placeholder=""											id="ckeditor_description" rows="4"><?=@$edit->description;?></textarea>									</div>								</div>
							</div>
