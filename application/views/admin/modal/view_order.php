				...
				<table class="table table-bordered">
					<tbody>
						...
						foreach($detail_order as $d){
							...
							?>
						<tr>
							<td class="hidden">								<?php if (file_exists(@$d->image)) { ?>
						...
						<tr>
							...
							<p class="hidden">Số tiên được giảm:  <?=  @$detail->code_sale; ?>%</p>
							<p class="hidden">Phí vận chuyển ship: <?=  number_format(@$detail->price_ship); ?> &nbsp;đ</p>
							<p>Tổng giá trị đơn hàng: <?=number_format(@$tootle);?>&nbsp;đ</p>
							</td>
						</tr>
					</tbody>
				</table>
