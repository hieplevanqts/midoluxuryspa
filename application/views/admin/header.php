        ...
        <ul class="nav navbar-nav">
		  ...
		  <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="<?= base_url('admin/admin/lang/vi') ?>"> Englisth</a></li>



              <li><a href="<?= base_url('admin/admin/lang/ko') ?>"> Hàn</a></li>

                <li><a href="<?= base_url('admin/admin/lang/ja') ?>"> Nhật</a></li>
...
<?php if($this->session->userdata('phanquyen')) {
    ...
    <li><a href="<?= base_url('vnadmin/admin/documentation')?>"><i class="fa fa-book"></i> <span>Hướng dẫn quản trị</span></a></li>
