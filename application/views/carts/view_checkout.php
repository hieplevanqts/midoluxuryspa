                                            ...
                                            <?php if(count($items)) : $total=0; ?>
                                                ...
                                                <td style="padding-top: 4%;">
                                                    <div class="pro-qty">
                                                        ...
                                                        <input disabled name="qty[]" id="quantity" value="<?=@$item['qty'];?>" size="4" title="Qty" class="form-control" maxlength="12">
                                                    </div>
                            ...
                            <div class="fix-margin-right thong-tin-don-hang" style="padding-top: 10px;">
                                ...
                                <hr>
                                    <div class="button_send">
                                        <div class="clearfix-20"></div>
                                        <button type="submit" name="update_cart_action" value="update_qty" title="Update Cart" class="button-3d-blue w_100 hidden">Cập nhật</button>
                                        <div class="clearfix-20"></div>
