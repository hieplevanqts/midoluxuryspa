...
function view_news_cate_table($data,$parent,$text,$show_home,$show_hot,$show_focus,$show_coupon){
    foreach ($data as $k=>$v) {
        if ($v->parent_id == $parent) {
            unset($data[$k]);
            $id = $v->id;
           ...
           view_news_cate_table($data, $id, $text . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ',$show_home,$show_hot,$show_focus,$show_coupon);
        }
    }
}
// hiện thị danh sach tin danh muc san pham
function view_product_cate_table($data,$parent=0,$text='',$show_home,$show_hot,$show_focus,$show_coupon){
    foreach ($data as $k=>$v) {
        if ($v->parent_id == $parent) {
            unset($data[$k]);
            $id = $v->id;
            ...
            view_product_cate_table($data, $id, $text . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ',$show_home,$show_hot,$show_focus,$show_coupon);
        }
    }
}
// hiện thị danh sach tin danh muc san pham
...
function view_media_cate_table($data,$parent=0,$text='',$show_home,$show_hot,$show_focus,$show_coupon){
    foreach ($data as $k=>$v) {
        if ($v->parent_id == $parent) {
            unset($data[$k]);
            $id = $v->id;
           ...
           view_media_cate_table($data, $id, $text . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ',$show_home,$show_hot,$show_focus,$show_coupon);
        }
    }
}
// hiện thị danh sach tin danh muc video
function view_video_cate_table($data,$parent=0,$text='',$show_home,$show_hot,$show_focus){
    foreach ($data as $k=>$v) {
        if ($v->parent_id == $parent) {
            unset($data[$k]);
            $id = $v->id;
            ...
            view_video_cate_table($data, $id, $text . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ',$show_home,$show_hot,$show_focus);
        }
    }
}
