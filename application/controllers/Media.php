...
class Media extends MY_Controller
{
    ...
    public function category($alias)
    {
        ...
        foreach($data['news_bycate'] as $value){
            $value->img = $this->m_media->get_data('media_images',array('id_item'=>$value->id));
            // echo '<pre>';
            // print_r($data['news_bycate']);
            // die();
        }
    ...
    // 
    public function photo_bycategory()
    {
        $data = array();
        ...
        foreach($data['cate'] as $value){
            $value->photo = $this->m_media->getListMedia($where,$config['per_page'], $this->input->get('per_page'));
        }
    ...
    public function detail($alias)
    {
        ...
        $data['listimg'] = $this->m_media->get_data('media_images',array('id_item'=>$media->id));
